...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0B0F17] text-slate-400 border-t border-amber-500/20 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 pb-12 border-b border-white/10">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[9px] tracking-widest text-amber-300/70 uppercase">
            ...
            <div className="flex items-center gap-2 text-xs text-amber-400/90 pt-2">
          ...
          <div>
            <h4 className="text-white text-sm font-bold uppercase tracking-wider mb-4 text-amber-400">
              Safari Tours
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/activities" className="hover:text-amber-400 transition-colors">
                  Desert Activities
                </Link>
              </li>
              <li>
