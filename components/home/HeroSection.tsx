...
import { ShieldCheck, MapPin, Sparkles, MessageCircle, CalendarCheck, Clock, Users } from "lucide-react";
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-[#0B0F17]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#0B0F17] via-[#0B0F17]/60 to-[#0B0F17]/80" />
      </div>

      {/* Content Container */}
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 text-center flex flex-col items-center">
        {/* Hero Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 backdrop-blur-md mb-6 animate-fade-in">
        ...
        {/* Main H1 Heading */}
        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white max-w-4xl leading-[1.1] mb-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mb-14">
          ...
          <Link
            href="/packages"
            className="w-full sm:w-auto px-7 py-4 rounded-xl bg-white/10 hover:bg-white/15 text-white font-semibold text-sm sm:text-base border border-white/20 backdrop-blur-md transition-all hover:scale-105 active:scale-95 text-center"
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-emerald-600/20 text-emerald-400 border border-emerald-500/30 hover:bg-emerald-600/30 font-semibold text-sm sm:text-base transition-colors text-center"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 w-full max-w-4xl pt-8 border-t border-white/10">
          <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/5 text-left">
            <MapPin className="w-5 h-5 text-amber-400 shrink-0" />
            <div>
              <p className="text-xs font-bold text-white">Hotel Pickup</p>
              <p className="text-[11px] text-slate-400">Available across Dubai</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/5 text-left">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Professional & Insured</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/5 text-left">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Family & Private tours</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/5 text-left">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Prompt daily support</p>
            </div>
          </div>
        </div>
      </div>
